...
void setup()
{
  ...
  others = new PanelOfTextButtons(105*Xsc,150*Ysc,220*Xsc,180*Ysc); others.back=color(100,100,100); viAreas.add(others);
  ...
  NextLeft=new PanelOfTextButtons(35*Xsc,10*Ysc,100*Xsc,40*Ysc); NextLeft.back=color(100,100,100); viAreas.add(NextLeft);   //Panel dla dających "NEXT" przycisków KPKR z lewej strony
  NextRight=new PanelOfTextButtons(230*Xsc,10*Ysc,360*Xsc,40*Ysc); NextRight.back=color(100,100,100); viAreas.add(NextRight);  //Panel dla dających  "NEXT" przycisków z prawej strony
  //Przyciski W+-NO
  WPlusMinusNO=new PanelOfTextButtons(230*Xsc,55*Ysc,360*Xsc,75*Ysc); WPlusMinusNO.back=color(100,100,100); viAreas.add(WPlusMinusNO);  
  ...
  points = new PanelOfTextButtons(230*Xsc,90*Ysc,360*Xsc,170*Ysc); viAreas.add(points);
  ...
  serves=new PanelOfTextButtons(10*Xsc,160*Ysc,100*Xsc,240*Ysc);  viAreas.add(serves);
  ...
  players = new PanelOfTextButtons(10*Xsc,55*Ysc,100*Xsc,105*Ysc); viAreas.add(players);
  ...
  courtT = new PanelOfTextButtons(120*Xsc,10*Ysc,220*Xsc,160*Ysc); viAreas.add(courtT);
  ...
  courtB = new PanelOfTextButtons(120*Xsc,170*Ysc,220*Xsc,320*Ysc); viAreas.add(courtB);
